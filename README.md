...
ミッション番号は1～3から選びます。
「ボタンを おした とき」または「ミッションが じかんぎれの とき」のイベント内で、
「ミッションを せいこうに する」「ミッションを しっぱいに する」ブロックを使って
結果を決めます。

ゲーム開始は「カウントダウン◯びょうで／ゲームを かいしする」ブロックで行います。
ゲーム時間は1～600秒の範囲で設定できます。
ゲームモードは「ゲームモードを ◯ に する」ブロックで、クリエイティブ、
アドベンチャー、サバイバル、スペクテイターから選びます。
賞金を毎秒変えるときは、ゲーム開始前の設定として
「1びょうごとの しょうきんを ふやす/へらす ◯に する」ブロックで
増減額を設定します。毎秒の加算・減算はアドオン側のゲーム時計で行います。
ハンターの視界は
「ハンターA～E／すべてのハンター の みつける ひろさを ◯ ブロックに する」ブロックで、
